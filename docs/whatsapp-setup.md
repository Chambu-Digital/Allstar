...
### 3. Quick Replies Setup
Set up these quick replies for common customer inquiries:
...
Browse Products
Call Us: +254 702 113 628
Visit Store: Agro House, Moi Avenue
```
...
Delivery charges apply for orders under KSH 10,000 or outside Nairobi.
```
...
### 4. Catalog Setup
Create a WhatsApp Business catalog with:
- Product categories (Home Appliances, Kitchen Electronics, etc.)
- Product images
- Prices in KSH
...
Create labels to organize customer chats:
- New Order
- Inquiry
- Delivery
- Support
...
## Updated Message Templates (Clean Format)
...
The website now generates clean, simple formatted WhatsApp messages when customers:
1. Click "Order via WhatsApp" in the cart
2. Use the WhatsApp contact links
3. Use the floating WhatsApp button

Messages include:
- Clean, simple formatting (no emojis or special characters)
