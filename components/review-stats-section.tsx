  ...
  const featuredTestimonials = [
    {
      ...
      comment: "I bought a Samsung refrigerator from Allstar Tech and the experience was fantastic. The team helped me choose the perfect size for my kitchen, and the delivery was prompt. The fridge has been working perfectly for 6 months now!",
    ...
    },
    {
      ...
      comment: "Allstar Tech has the best prices and genuine products. I've bought my TV, microwave, and blender from them. Their after-sales service is excellent, and they always follow up to ensure everything is working well.",
      customerName: "John K.",
    ...
    },
    {
      ...
      comment: "I was skeptical about buying electronics online, but Allstar Tech exceeded my expectations. The smartphone I ordered arrived in perfect condition with all accessories. Their customer support team is very responsive and helpful.",
    ...
    },
    {
      ...
      comment: "Allstar Tech offers competitive prices without compromising on quality. I compared prices from multiple stores, and they had the best deal. Plus, their warranty service is reliable and hassle-free.",
      customerName: "Mary N.",
